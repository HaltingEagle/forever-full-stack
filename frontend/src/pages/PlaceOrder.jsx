...
const PlaceOrder = () => {
  ...
  const {navigate, backendURL, setCartItems, cartItems, getCartAmount, delivery_fee, token, products} = useContext(ShopContext);
      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          ...
          <div className="w-full mt-8 text-end">
            <button onClick={onSubmitHandler} type='submit' className='px-16 py-3 text-sm text-white bg-black'>PLACE ORDER</button>
          </div>
        </div>
      </div>
    </form>
